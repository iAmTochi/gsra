                            ...
                            <form class="row" action="{{  isset($gallery) ? route('galleries.update', $gallery->id) : route('galleries.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="row">
                                        ...
                                        <div class=" col-md-6">
                                            <div class="form-group">
                                                <label class="text-dark ft-medium">{{ isset($gallery) ? 'Change Passport?':'Passport' }}</label>
                                            ...
                                            @isset($gallery)
                                                @method('PUT')
                                                <img src="{{asset('storage/'.$gallery->photo ) }}" class="img-fluid circle text-center" width="100" alt="" />
                                            @endisset
                                        </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($galleries as  $gallery)
                                        <tr>
                                            ...
                                            <td><img src="{{asset('storage/'.$gallery->photo ) }}" class="img-fluid circle" width="70" alt="" /></td>
                                            ...
                                            <td>
                                                <div class="dash-action">
                                                    ...
                                                    <a href="" class="p-2 circle text-success bg-light-success d-inline-flex align-items-center justify-content-center"><i class="lni lni-pencil"></i></a>
                                                    ...
                                                    <a href="{{ route('testimonies.edit', $gallery->id)}}" class="p-2 circle text-success bg-light-success d-inline-flex align-items-center justify-content-center my-2"><i class="lni lni-pencil"></i></a>
                                                    <button type="button" onclick="handleDelete({{ $gallery->id }})" class="p-2 circle text-danger bg-light-danger d-inline-flex align-items-center justify-content-center ml-1"><i class="lni lni-trash-can"></i></button>
