                ...
                <div class="colxl-12 col-lg-12 col-md-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#" class="theme-cl">View Article Tags</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="cl-justify-last">
                            <div class="d-flex align-items-center justify-content-left">
                                ...
                                <div class="dlc-list ml-2">
                                    <a href="{{ route('article-tags.create') }}" style="background-color: black" class="btn  btn-secondary rounded">Add Tag</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 25px">
                                            <div class="dash-action">
                                                ...
                                                <button type="button" onclick="handleDelete({{ $tag->id }})" class="p-2 circle text-danger bg-light-danger d-inline-flex align-items-center justify-content-center ml-1"><i class="lni lni-trash-can"></i></button>
            ...
            <form action="" method="POST" id="deleteCourseForm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalLabel">Delete Tage</h5>
...
@section('scripts')
    <script>
        function handleDelete(id) {
            ...
            form.action = '/admin/article-tags/' + id;
