                                        ...
                                        <div class="col-xl-12 col-lg-12 education-field">
                                            <div class="gray rounded p-3 mb-3 position-relative">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $education->institution }}" type="text" name="school[]" class="form-control rounded {{ $errors->has('school[]') ? ' is-invalid' : '' }}" placeholder="School Name">
                                                    <span role="alert" class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $education->qualification }}"  type="text" name="qualification[]" class="form-control rounded {{ $errors->has('qualification[]') ? ' is-invalid' : '' }}" placeholder="Qualification Title">
                                                    <span role="alert" class="invalid-feedback">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $education->started_at }}" type="date" name="school_start_date[]" class="form-control rounded" placeholder="dd-mm-yyyy">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                        ...
                                        <div class="experience-field col-xl-12 col-lg-12">
                                            <div class="gray rounded p-3 mb-3 position-relative">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $experience->employer }}" type="text" name="employer[]" class="form-control rounded {{ $errors->has('employer[]') ? ' is-invalid' : '' }}" placeholder="Employer Name">
                                                    <span role="alert" class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $experience->job_title }}" type="text" name="job_title[]" class="form-control rounded {{ $errors->has('job_title[]') ? ' is-invalid' : '' }}" placeholder="Designation Title">
                                                    <span role="alert" class="invalid-feedback">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label class="text-dark ft-medium">Start Date</label>
                                                            <input value="{{ $experience->started_at }}" type="date" name="job_start_date[]" class="form-control rounded {{ $errors->has('job_start_date[]') ? ' is-invalid' : '' }}" placeholder="dd-mm-yyyy">
                                                            <span role="alert" class="invalid-feedback">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label class="text-dark ft-medium">End Date</label>
                                                            <input value="{{ $experience->resigned_at }}" type="date" name="job_end_date[]" class="form-control rounded {{ $errors->has('job_end_date[]') ? ' is-invalid' : '' }}" placeholder="dd-mm-yyyy">
                                                            <span role="alert" class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="responsibility[]" class="form-control ht-80 {{ $errors->has('responsibility') ? ' is-invalid' : '' }}" placeholder="Job Responsibilites">{{ $experience->responsibilities }}</textarea>
                                                    <span role="alert" class="invalid-feedback">
                                        ...
                                        <div class="col-xl-12 col-lg-12 skill-field">
                                            <div class="gray rounded p-3 mb-3 position-relative">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $skill->name }}" type="text" name="skill_name[]" class="form-control rounded {{ $errors->has('skill_name[]') ? ' is-invalid' : '' }}" placeholder="Skills Name">
                                                    <span role="alert" class="invalid-feedback">
